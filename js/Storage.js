...
// ready
// console.log(onload);
function Storage(db_name, tb_name) {
    ...
    obj.setItem = function (key, v) {
        v = { value: v }
        v[keyPath] = key;
        return item([v], "put", false, null, null, !isValidKey(key) && [])
    };
    ...
    opener(db_name, tb_name, event, !(!records))
}


// var obj = Storage.prototype//={}

var opener = function (db, tb, event, track) {
